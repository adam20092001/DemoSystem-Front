...
export const routes: Routes = [
  ...
  { path: '', component: AppShellComponent, canActivate: [authGuard, passwordChangeGuard], children: [
    ...
    { path: 'pos', canActivate: [roleGuard], data: { roles: ['ADMIN', 'SELLER'], title: 'Punto de venta', eyebrow: 'Ventas', description: 'Venta directa, selección de productos y pago inicial en un solo flujo.' }, loadComponent: () => import('./features/placeholder/feature-placeholder.page').then(m => m.FeaturePlaceholderPage) },
